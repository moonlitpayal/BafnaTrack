...
class _QuotationScreenState extends State<QuotationScreen> {
  ...
  Future<void> _fetchProjectImages(String projectId) async {
    ...
    final response = await supabase.from('documents').select('file_path').eq('project_id', projectId).eq('document_type', 'Quotations');
    final urls = <String>[];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('View Quotations', style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
        ...
        children: [
            ...
            child: FutureBuilder<List<ProjectInfo>>(
              ...
              builder: (context, snapshot) {
                ...
                return DropdownButtonFormField<ProjectInfo>(
                  ...
                  decoration: const InputDecoration(labelText: 'Select a Project to View Quotations', border: OutlineInputBorder()),
          ...
          Expanded(
            child: _isLoadingImages
                ...
                : _imageUrls.isEmpty
                ? Center(child: Text(_selectedProject == null ? 'Please select a project.' : 'No quotations found for this project.', style: GoogleFonts.poppins(fontSize: 16, color: Colors.grey[600])))
                : GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector( // ### THIS IS THE CHANGE ###
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
